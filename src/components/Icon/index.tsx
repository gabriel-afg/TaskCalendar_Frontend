...
export function Icon({ name }: { name: string }) {
    return (
        <img
            src="data:image/svg+xml;base64,"
            width="24"
            height="24"
            alt=""
        />
